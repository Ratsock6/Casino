...
const LEVEL_REWARDS: Record<number, {
  ...
  20: { tokens: 16000, description: '16 000 jetons' },
  21: { tokens: 18000, description: '18 000 jetons' },
  22: { tokens: 20000, description: '20 000 jetons' },
  23: { tokens: 22000, description: '22 000 jetons' },
  24: { tokens: 24000, description: '24 000 jetons' },
  25: { tokens: 26000, badge: '🥈 Argent', description: '26 000 jetons + Badge 🥈 Argent' },
  26: { tokens: 28000, description: '28 000 jetons' },
  27: { tokens: 30000, description: '30 000 jetons' },
  28: { tokens: 32000, description: '32 000 jetons' },
  29: { tokens: 34000, description: '34 000 jetons' },
  30: { tokens: 36000, description: '36 000 jetons' },
  31: { tokens: 38000, description: '38 000 jetons' },
  32: { tokens: 40000, description: '40 000 jetons' },
  33: { tokens: 42000, description: '42 000 jetons' },
  34: { tokens: 44000, description: '44 000 jetons' },
  35: { ingame: 'Sultan RS', ingameValue: 875000, description: '🏎️ Sultan RS — à récupérer en jeu' },
  36: { tokens: 48000, description: '48 000 jetons' },
  37: { tokens: 50000, description: '50 000 jetons' },
  38: { tokens: 52000, description: '52 000 jetons' },
  39: { tokens: 54000, description: '54 000 jetons' },
  40: { tokens: 56000, description: '56 000 jetons' },
  41: { tokens: 58000, description: '58 000 jetons' },
  42: { tokens: 60000, description: '60 000 jetons' },
  43: { tokens: 62000, description: '62 000 jetons' },
  44: { tokens: 64000, description: '64 000 jetons' },
  45: { ingame: 'Pfister Comet 5', ingameValue: 1200000, description: '🏎️ Pfister Comet 5 — à récupérer en jeu' },
  46: { tokens: 68000, description: '68 000 jetons' },
  47: { tokens: 70000, description: '70 000 jetons' },
  48: { tokens: 72000, description: '72 000 jetons' },
  49: { tokens: 74000, description: '74 000 jetons' },
  50: { tokens: 76000, badge: '🥇 Or', vipDuration: '1_MONTH', description: '76 000 jetons + Badge 🥇 Or + VIP 1 mois' },
  51: { tokens: 78000, description: '78 000 jetons' },
  52: { tokens: 80000, description: '80 000 jetons' },
  53: { tokens: 82000, description: '82 000 jetons' },
  54: { tokens: 84000, description: '84 000 jetons' },
  55: { ingame: 'Carbonizzare', ingameValue: 1562000, description: '🏎️ Carbonizzare — à récupérer en jeu' },
  56: { tokens: 88000, description: '88 000 jetons' },
  57: { tokens: 90000, description: '90 000 jetons' },
  58: { tokens: 92000, description: '92 000 jetons' },
  59: { tokens: 94000, description: '94 000 jetons' },
  60: { tokens: 96000, description: '96 000 jetons' },
  61: { tokens: 99000, description: '99 000 jetons' },
  62: { tokens: 102000, description: '102 000 jetons' },
  63: { tokens: 105000, description: '105 000 jetons' },
  64: { tokens: 108000, description: '108 000 jetons' },
  65: { ingame: 'Elegy', ingameValue: 2000000, description: '🏎️ Elegy — à récupérer en jeu' },
  66: { tokens: 114000, description: '114 000 jetons' },
  67: { tokens: 117000, description: '117 000 jetons' },
  68: { tokens: 120000, description: '120 000 jetons' },
  69: { tokens: 123000, description: '123 000 jetons' },
  70: { tokens: 126000, description: '126 000 jetons' },
  71: { tokens: 129000, description: '129 000 jetons' },
  72: { tokens: 132000, description: '132 000 jetons' },
  73: { tokens: 135000, description: '135 000 jetons' },
  74: { tokens: 138000, description: '138 000 jetons' },
  75: { ingame: 'Cheetah', ingameValue: 2800000, description: '🏎️ Cheetah — à récupérer en jeu' },
  76: { tokens: 144000, description: '144 000 jetons' },
  77: { tokens: 147000, description: '147 000 jetons' },
  78: { tokens: 150000, description: '150 000 jetons' },
  79: { tokens: 153000, description: '153 000 jetons' },
  80: { tokens: 156000, description: '156 000 jetons' },
  81: { tokens: 160000, description: '160 000 jetons' },
  82: { tokens: 164000, description: '164 000 jetons' },
  83: { tokens: 168000, description: '168 000 jetons' },
  84: { tokens: 172000, description: '172 000 jetons' },
  85: { tokens: 176000, description: '176 000 jetons' },
  86: { tokens: 180000, description: '180 000 jetons' },
  87: { tokens: 184000, description: '184 000 jetons' },
  88: { ingame: 'Turismo R', ingameValue: 12000000, description: '🏎️ Turismo R — à récupérer en jeu' },
  89: { tokens: 192000, description: '192 000 jetons' },
  90: { tokens: 196000, description: '196 000 jetons' },
  91: { tokens: 200000, description: '200 000 jetons' },
  92: { tokens: 204000, description: '204 000 jetons' },
  93: { tokens: 208000, description: '208 000 jetons' },
  94: { tokens: 212000, description: '212 000 jetons' },
  95: { tokens: 216000, description: '216 000 jetons' },
  96: { tokens: 220000, description: '220 000 jetons' },
  97: { ingame: 'Mercedes GT63s', ingameValue: 15000000, description: '🏎️ Mercedes GT63s — à récupérer en jeu' },
  98: { tokens: 228000, description: '228 000 jetons' },
  99: { tokens: 232000, badge: '🌟 Diamant', vipDuration: '6_MONTHS', description: '232 000 jetons + Badge 🌟 Diamant + VIP 6 mois' },
  100: { tokens: 236000, badge: '👑 Légendaire', vipDuration: 'LIFETIME', ingame: 'AMG GTC + Manoir privé', ingameValue: 35000000, description: '236 000 jetons + Badge 👑 Légendaire + VIP à vie + 🏆 AMG GTC + Manoir privé — à récupérer en jeu' },
};
